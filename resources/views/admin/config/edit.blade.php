        ...
        <form action="{{url("admin/config/".$field->conf_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>类型：</th>
                    <td>
                        <input type="radio" name="conf_type" value="input" @if($field->conf_type=="input") checked @endif onclick="showTextarea()">input&nbsp&nbsp&nbsp&nbsp
                        <input type="radio" name="conf_type" value="textarea" @if($field->conf_type=="textarea") checked @endif onclick="showTextarea()">textarea&nbsp&nbsp&nbsp&nbsp
                        <input type="radio" name="conf_type" value="radio" @if($field->conf_type=="radio") checked @endif onclick="showTextarea()">radio&nbsp&nbsp&nbsp&nbsp
                    </td>
                </tr>
                <tr class="conf_value">
                    <th>类型值：</th>
                    <td >
                        <input class="sm" type="text" name="conf_value" value="{{$field->conf_value}}">
