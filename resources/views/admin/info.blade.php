    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>上传附件限制</label><span><?php echo get_cfg_var("upload_max_filesize")?get_cfg_var("upload_max_filesize"):"不允许上传附加"?></span>
                </li>
                <li>
                    <label>北京时间</label><span><?php echo date("Y年m月d日 h:i"); ?></span>
                </li>
                <li>
